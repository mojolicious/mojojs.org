<!doctype html><html>
  <head>
    <link rel="apple-touch-icon" href="<%= ctx.urlForFile('/mojo/touch-icon.png') %>">
    <link rel="apple-touch-icon" sizes="152x152" href="<%= ctx.urlForFile('/mojo/touch-icon-152x152.png') %>">
    <link rel="apple-touch-icon" sizes="167x167" href="<%= ctx.urlForFile('/mojo/touch-icon-167x167.png') %>">
    <link rel="apple-touch-icon" sizes="180x180" href="<%= ctx.urlForFile('/mojo/touch-icon-180x180.png') %>">
